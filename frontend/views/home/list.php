...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到MODM！[<a href="<?php echo \yii\helpers\Url::to(['register/logout'])?>">退出登陆] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            ...
            <ul>
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['home/goods','id'=>$data['id']]);?>"><img src="<?="http://admin.yiishop.com".$data['logo'];?>"/></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['home/goods','id'=>$data['id']]);?>"><?=$data['name'];?></a></dt>
                        <dd><strong><?=$data['shop_price'];?></strong></dt>
                        <dd><em><?php if($data['status']===1){echo "在售";}else{echo "已下架";};?></em></dt>
                    </dl>
                </li>
                <?php endforeach;?>
            </ul>
