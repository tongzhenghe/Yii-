    ...
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                ...
                <li class="fl"><a href="<?php echo \yii\helpers\Url::to(['register/logout'])?>">退出登陆</a></li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <?php foreach ($models as $k=>$model):;?>
                <div class="cat <?=$k?"":"item1"?>">
                    <h3><a href="<?php echo \yii\helpers\Url::to(['home/list','goods_category_id'=>$model->id]);?>" ><?=$model->name;?></a> <b></b></h3>
                    <div class="cat_detail">
                        <?php foreach ($model->childrens as $j=>$children):?>
                            <dl <?=$j?'':'class="dl_1st"'?>>
                            <dt><a href="<?php echo \yii\helpers\Url::to(['home/list','goods_category_id'=>$children->id]);?>"><?=$children->name?></a></dt>
                            <dd>
                                <?php foreach ($children->childrens as $child):;?>
                                <a href="<?php echo \yii\helpers\Url::to(['home/list','goods_category_id'=>$child->id]);?>"><?=$child->name?></a>
                                <?php endforeach;?>
                            </dd>
                        </dl>
                        <?php endforeach;?>
