...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to(['register/login'])?>">登录</a>] [<a href="register.html">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
<!--                    <a href="/images/preview_l1.jpg" class="jqzoom" rel="gal1"> http://admin.yiishop.com/upload/66/31/663112def2f33fa7622dacd0fbc7525a84bfdf02.jpg  <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->-->
                        <img src="<?="http://admin.yiishop.com".$rows['logo'];?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="<?="http://admin.yiishop.com".$rows['logo'];?>"></a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?php echo $rows['id'];?></li>
                    <li class="market_price"><span>定价：</span><em><?=$rows['shop_price']?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong><?=$rows['market_price']?></strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?=$rows['create_time']?></li>
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?php echo \yii\helpers\Url::to(['home/notice']);?>" method="get" class="choose">
                    <ul>
                        <li>
                            <dl>
                                <dt>购买数量：</dt>
                                <dd>
                                    ...
                                    <input type="text" name="amount" value="<?=$rows['stock']?>" class="amount"/>
                        ...
                        <li>
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd>
                                    <input type="hidden" name="goods_id" value="<?=$rows['id'];?>"/>
