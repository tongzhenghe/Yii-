...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to(['home/login'])?>">登录</a>] [<a href="">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr>
            <tr data-id="<?=$model->id?>">
            <td class="col1"><a href=""><img src="<?='http://admin.yiishop.com'.$model->logo;?>" alt="" /></a>  <strong><a href=""><?=$model->name;?></a></strong></td>
    ...
    <div class="cart_btn w990 bc mt10">
        ...
        <a href="<?=\yii\helpers\Url::to(['home/order']);?>" class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
<div style="clear:both;"></div>
