...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到moemo！[<a href="http://home.yiishop.com/register/login">登录</a>]</li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
...
<div class="header w990 bc mt15">
    <div class="logo w990">
        <h2 class="fl"><a href="index.html"><img src="/imageslogo.png" alt="京西商城"></a></h2>
    </div>
</div>
<!-- 页面头部 end -->
...
<div class="login w990 bc mt10 regist">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form action="<?=\yii\helpers\Url::to(['register/reg']);?>" method="post">
                <ul>
                    <li>
                        <label for="">用户名：</label>
                    ...
                    <li>
                        ...
                        <input type="text" class="txt" value="" name="tel" id="tel" placeholder="请输入手机号码"/>
                    </li>
                    <li>
                        <label for="">验证码：</label>
...
<div class="footer w1210 bc mt15">
    ...
    <p class="auth">
        <a href=""><img src="/imagesxin.png" alt="" /></a>
        <a href=""><img src="/imageskexin.jpg" alt="" /></a>
        <a href=""><img src="/imagespolice.jpg" alt="" /></a>
        <a href=""><img src="/imagesbeian.gif" alt="" /></a>
    </p>
</div>
<!-- 底部版权 end -->
