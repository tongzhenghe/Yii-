...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="<?php echo \yii\helpers\Url::to(['register/logout']);?>">退出</a>]</li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
    ...
    <div class="logo w1210">
        ...
        <div class="search fl">
            <div class="search_form">
                ...
                <form action="" name="serarch" method="post" class="fl">
            ...
            <dl class="last">
                <p>
                    <?php foreach($shuju as $val):?>
                        ...
                        <?=$val->tel;?>
                <dd>
                    <a href="<?php echo \yii\helpers\Url::to(['address/edit','id'=>$val['id']])?>">修改</a>
                    <a href="<?php echo \yii\helpers\Url::to(['address/del','id'=>$val['id']])?>">删除</a>
                    <a href="">设为默认地址</a>
                </dd>
                    <?php Endforeach;?>
                </p>
            ...
            <form  name="address_form" method="post">
                <ul>
                    <li>
                        ...
                        <input type="text" name="consignee" class="txt"  value="<?=isset($data->consignee)?$data->consignee:$data="";?>"/>
                    </li>
                    <li>
...
<!--                        </select>-->
                        <select id="cmbProvince" name="town"></select>
                        <select id="cmbCity" name="district"></select>
                        <select id="cmbArea" name="place"></select>
...
//                                    $.getJSON("http://home.yiishop.com/address/add",function (data) {
//                                        //遍历取出市name和Coed
//                                    });
//                                });
//                            }
...
<!--                        <select name="place" id="place"> <option value="">请选择</option>-->
<!--                            <option value="">西二旗</option>-->
<!--                            <option value="">西三旗</option>-->
<!--                            <option value="">三环以内</option></select>-->


                    </li>
                    <li>
                        <label for=""><span>*</span>详细地址：</label>
                        <input type="text" name="detailedAddress" class="txt address" value="<?=isset($data->detailedAddress)?$data->detailedAddress:$data="";?>" />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" name="tel" class="txt"  value="<?=isset($data->tel)?$data->tel:$data="";?>"/>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
